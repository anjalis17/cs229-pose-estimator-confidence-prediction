# src/importance_weighting.py
"""
Importance-weighted failure prediction (covariate-shift adaptation).
...
Outputs:
  results/NEW_DATA/importance_weighting_results.csv
...
from anomaly_detectors import load_features, KEEP_NAMES, RESULTS_DIR
...
def main():
    ...
    print(f'\nSaved → results/NEW_DATA/importance_weighting_results.csv')
